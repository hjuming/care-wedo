...
> 目前測試期間：一般測試帳號開放 Family Pro 權限；無限版本僅限日月MING 內部管理帳號，不對外開放。
...
公開方案級距依 `plans` 資料表規劃，首頁先顯示 Free 到 Family Pro；Care Team 先隱藏，不放入公開首頁。測試期間新建立的家庭群組預設為 Family Pro。

| 方案 | OCR/月 | 家庭群組 | 成員/群組 | 照護對象/群組 | 建議月費 | 公開狀態 |
|---|---:|---:|---:|---:|---:|---|
| Free | 10 | 1 | 1 | 1 | NT$0 | 公開 |
| Family Basic | 30 | 1 | 2 | 1 | NT$99/月 | 公開 |
| Family Plus | 50 | 1 | 5 | 2 | NT$199/月 | 公開 |
| Family Pro | 100 | 1 | 8 | 4 | NT$399/月 | 公開；測試期預設 |
| Care Team | 200 | 1 | 15 | 8 | NT$899/月 | 先隱藏；不放首頁 |
| 無限版本 | 不限 | 多個 | 不限 | 不限 | 不販售 | 僅日月MING 內部管理帳號 |

方案設計重點：

- Family Pro 標準能力是 1 個家庭群組、8 位成員、4 位照護對象。
- 多家庭群組不是 Family Pro 標準能力；只透過 `multiple_family_groups` feature flag 開給日月MING 內部管理帳號。
- Care Team 先保留在資料表與內部規劃，不放入公開首頁，不對一般測試帳號開放。
- 無限版本不是商業方案，不提供訂閱、不對外販售、不出現在公開方案表。
- 建議月費為商務規劃基準，正式商轉前可依 Beta 使用量與回饋調整。

權限規則：

- 一般測試帳號：Family Pro，登入後家人協作頁標示 `Family Pro`。
- 日月MING 內部管理帳號：顯示「無限版本」，可建立多個家庭群組。
- 無限版本不提供給其他帳號，也不放入公開方案介紹。
