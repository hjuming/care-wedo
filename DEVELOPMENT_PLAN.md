...
> **測試政策**：系統測試期間一般測試帳號開放 Family Pro 權限；日月MING 內部管理帳號顯示「無限版本」並可建立多個家庭群組。
...
- 一般測試帳號開放 Family Pro 權限：100 OCR/月、8 位成員、4 位照護對象。
- 日月MING 內部管理帳號顯示「無限版本」，可建立多個家庭群組。
- 無限版本不提供給其他帳號，也不放入公開首頁方案。
- 回饋將作為正式版方案設計依據。
...
| Care Team | 200 | 15 | 8 | 是，先隱藏，不對外顯示 |

公開首頁顯示規則：

- 顯示 Free、Family Basic、Family Plus、Family Pro。
- Care Team 先隱藏。
- 「規劃中」可點開放大檢視公開方案級距。
- 登入後的家人協作頁右上角顯示目前權限版本；一般測試帳號顯示 Family Pro，日月MING 顯示無限版本。
