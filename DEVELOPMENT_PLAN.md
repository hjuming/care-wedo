...
> **測試政策**：系統測試期間所有測試帳號暫時開放 Family Pro 權限；內部管理權限不作為公開方案呈現。
...
- **家人語氣**：通知要像家人順手提醒，不像系統公告、客服話術或制式條文。
...
| SEO / AIO / GEO | ✅ 已完成 | 社交分享圖、OG/Twitter meta、JSON-LD、FAQPage、sitemap、robots、llms |
...
- 清楚說明測試期間一般測試帳號開放 Family Pro 權限。
- 方案比較改為「Free / Family Pro」。
...
## 5. Free 與 Family Pro 功能差異

測試期間：

- 一般測試帳號開放 Family Pro 權限：100 筆圖片解析/月、8 位成員、4 位照護對象。
...
| 方案 | 圖片解析 | 家人協作 | 照護對象 | 家庭共享 |
|---|---:|---:|---:|---|
| Free 免費版 | 10筆/月 | 1位 | 1位 | 否 |
| Family Basic 基礎版 | 30筆/月 | 2位 | 1位 | 是 |
| Family Plus 進階版 | 50筆/月 | 5位 | 2位 | 是 |
| Family Pro 超級版 | 100筆/月 | 8位 | 4位 | 是 |
| Care Team | 200筆/月 | 15位 | 8位 | 是，先隱藏，不對外顯示 |

公開首頁顯示規則：

- 主頁只顯示 Free 與 Family Pro 對照。
- Free、Family Basic、Family Plus、Family Pro 細部級距收在 Family Pro 小視窗中。
- Care Team 先隱藏。
- 點選 Family Pro 可開啟小視窗檢視公開方案級距。
- 登入後的家人協作頁右上角顯示目前權限版本；測試期顯示 Family Pro。
