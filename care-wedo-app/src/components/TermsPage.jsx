    ...
    <main className="legal-page-shell">
      ...
      <article className="legal-content">
        ...
        <section className="disclaimer-banner">
          ...
          <p>
            如有任何健康疑慮或症狀，請務必諮詢合格醫療人員。緊急情況請撥打 119 或前往最近的急診室。
          </p>
        </section>

        <section>
          <h2>1. 服務說明</h2>
          <p>Care WEDO（以下稱「本服務」）由 WEDO 團隊提供，透過 LINE LIFF、Web Dashboard 及 LINE Bot 三個入口，協助家庭管理長輩的就診與用藥資訊。</p>
        </section>
        ...
        <section>
          <h2>7. 聯絡我們</h2>
          <p>如有問題，請聯繫：<a href="mailto:support@wedopr.com">support@wedopr.com</a></p>
        </section>
